                ...
                <section class="htlleo-event-sessions">
                    ...
                    <div class="htlleo-session-list">
                        ...
                        <div class="htlleo-session-card <?php echo $is_available?'htlleo-session-available':'htlleo-session-full'; ?>" 
                            ...
                            <p><?php echo esc_html($session['group_name']); ?></p>
                            <p><?php echo esc_html($session['start_time']); ?> - <?php echo esc_html($session['end_time']); ?></p>
                            <p><?php echo intval($session['capacity']) - intval($registrations_count); ?> Plätze frei</p>
                        </div>
                        <?php endforeach; ?>
                    </div>
                </section>
            ...
            cards.forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    form.addEventListener('submit', function(e){
                        ...
                        // Read the session_id from the hidden input
                        const sessionInput = form.querySelector('input[name="session_id"]');
                        if (!sessionInput) {
                            alert('Fehler: Session nicht gefunden.');
                            return;
                        }
