                ...
                <?php foreach($events as $event): ?>
                    <tr class="event-row" data-event-id="<?php echo $event['id']; ?>">
                        ...
                        <td>
                            ...
                            <button class="button copy-shortcode" data-event-id="<?php echo $event['id']; ?>">Copy Shortcode</button>
                        </td>
                    </tr>
...
jQuery(document).ready(function($){
    ...
    // Copy shortcode to clipboard with tooltip
    $('.copy-shortcode').on('click', function(){
        var button = $(this);
        var eventId = button.data('event-id');
        var shortcode = '[htlleo_event id="' + eventId + '"]';
        ...
        // Create tooltip
        var tooltip = $('<div class="shortcode-tooltip">Shortcode ' + shortcode + ' copied to clipboard</div>');
        $('body').append(tooltip);
        ...
        // Hide and remove tooltip after 1.5s
        setTimeout(function(){ 
            tooltip.remove(); 
        }, 1500);
    });
